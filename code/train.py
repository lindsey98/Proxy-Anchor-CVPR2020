...
parser.add_argument('--epochs', default = 50, type = int,dest = 'nb_epochs',help = 'Number of training epochs.')
...
for epoch in range(0, args.nb_epochs):
    ...
    # Best model save
    os.makedirs('{}'.format(LOG_DIR), exist_ok=True)
    torch.save({'model_state_dict':model.state_dict()},
               '{}/{}_{}_{}_best.pth'.format(LOG_DIR, args.dataset, args.model, args.loss))
